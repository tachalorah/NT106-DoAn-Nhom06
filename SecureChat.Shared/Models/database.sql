...
create database if not exists SecureChat default character set utf8mb4 collate utf8mb4_unicode_ci;
use SecureChat;
...
create table if not exists Users (
    ...
    hashed_b_key text not null,
    hashed_recovery_key text not null,
